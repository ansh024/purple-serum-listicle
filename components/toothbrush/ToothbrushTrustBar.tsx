...
/** Clickable trust band that opens a pop-up image on click. */
export default function ToothbrushTrustBar() {
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* Replace with the pop-up image when provided (mobile + desktop) */}
            <Placeholder
              label="Trust bar pop-up (image pending)"
